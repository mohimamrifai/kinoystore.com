    ...
    <div className="min-h-dvh grid place-items-center px-6">
      <div className="w-full max-w-md md:max-w-lg lg:max-w-xl">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-5">
              ...
              <div className="-mt-2 text-right text-sm">
                <Link href="/forgot-password" className="font-medium text-[#ff731a] hover:underline">Lupa Password ?</Link>
              </div>
              <Button type="submit" size="lg" className="w-full h-11 text-base bg-[#ff731a] text-white hover:bg-[#e86615] dark:bg-[#ff731a] dark:hover:bg-[#e86615] cursor-pointer">Masuk</Button>
        ...
        <div className="mt-4 text-center text-sm text-gray-600 dark:text-gray-400">
          <span>
            Belum punya akun? <Link href="/register" className="font-medium text-[#ff731a] hover:underline">Daftar</Link>
          </span>
        </div>
      </div>
    </div>
