...
import { Menu, Package, ListChecks, Mail } from "lucide-react"

export default function Navbar() {
  return (
    <motion.header
      className="sticky top-0 z-40 bg-white/70 dark:bg-black/50 backdrop-blur border-b border-gray-200 dark:border-neutral-800"
    ...
    >
      <div className="mx-auto max-w-6xl px-6 py-3 sm:py-4 grid grid-cols-[auto_1fr_auto] items-center gap-3 sm:gap-4">
        <div className="flex items-center gap-2">
          ...
          />
          <Link href="/" className="text-lg sm:text-xl font-bold leading-none">kinoystore.com</Link>
        </div>
