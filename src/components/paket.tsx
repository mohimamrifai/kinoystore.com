  ...
  return (
    <section id="paket" className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        <h2 className="text-3xl sm:text-5xl font-bold leading-snug text-center">Pilih Paket Sesuai
        ...
        <p className="mt-2 text-lg text-center text-gray-600 dark:text-gray-300">Pilih durasi, device, dan grade yang sesuai kebutuhan Anda.</p>
