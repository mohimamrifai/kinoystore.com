  ...
  return (
    <section className="relative overflow-hidden">
      <div className="mx-auto max-w-6xl px-6 pt-14 pb-16 grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-10 items-center">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-white/30 dark:border-white/10 px-4 py-2 sm:px-5 sm:py-2 text-sm md:text-base font-medium text-gray-800 dark:text-gray-100 bg-white/40 dark:bg-white/10 backdrop-blur">
            <ShieldCheck className="size-4 md:size-5" />
            Partner Resmi & Terpercaya Redfinger
          </div>
          <h1 className="text-3xl sm:text-5xl font-extrabold leading-tight">
            Beli Kode Redfinger Resmi Indonesia.
            <span className="block text-transparent bg-clip-text bg-linear-to-r from-black via-rose-600 to-indigo-600 dark:from-white dark:via-rose-400 dark:to-indigo-300">Instan & Aman</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button size="lg" className="text-base bg-red-600 text-white hover:bg-red-700 transition-all hover:-translate-y-0.5 hover:shadow-lg" asChild>
              <Link href="#paket">Lihat Produk</Link>
            </Button>
            <Button variant="outline" size="lg" className="text-base transition-all hover:-translate-y-0.5 hover:shadow-lg" asChild>
          ...
          <div className="mt-3 flex flex-wrap items-center gap-3 text-sm md:text-base">
            ...
            <span className="inline-flex items-center gap-2 rounded-full border border-white/20 dark:border-white/10 bg-white/40 dark:bg-white/10 backdrop-blur px-3 py-1 md:px-4 md:py-1.5 text-gray-800 dark:text-gray-100">
              <Headphones className="h-4 w-4 md:h-5 md:w-5 text-sky-600 dark:text-sky-400" />
              Bantuan 24/7
            </span>
          </div>
        </motion.div>
