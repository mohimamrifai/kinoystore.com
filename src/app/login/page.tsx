          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-4">
              ...
              <div className="-mt-2 text-right text-xs">
                <Link href="/forgot-password" className="font-medium text-red-600 hover:underline">Lupa Password</Link>
              </div>
              <Button type="submit" className="w-full bg-red-600 hover:bg-red-700 text-white">Login</Button>
              <Button type="button" variant="outline" className="w-full">Login dengan Google</Button>
            </form>
          </Form>
        </div>
        <div className="mt-3 text-center text-xs text-gray-600 dark:text-gray-400">
          <span>
            Belum punya akun? <Link href="/register" className="font-medium text-red-600 hover:underline">Daftar</Link>
          </span>
        </div>
      </div>
    </div>
